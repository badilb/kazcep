...
const i18n = {
  ru: {
    ...
    "about-title": "ТОО «КазЦЭП»<br>— развиваемся ВМЕСТЕ!",
    "about-desc1": "На строительном рынке компания «КазЦЭП» работает более 12 лет. Накоплен огромный опыт в работах самого разного профиля по всей территории Республики Казахстан.",
    "about-desc2": "Компания преуспела как в промышленном, так и в гражданском строительстве. Среди наших заказчиков — АО «КТЖ», KEGOC, BI Group, Huawei, Казахтелеком, Kcell, Beeline, Халык Банк, КазТрансГаз.",
    "lic-1": "Лицензия ПИР №13015116 — Проектная деятельность II категории",
    ...
    "res-staff": "сотрудников<br><small>(10 проектировщиков TSSR)</small>",
    ...
    "proj-kartel-2": "Монтаж новых БС «под ключ» — 10 сайтов",
    ...
    "adv-1-title": "Проектная команда", "adv-1-desc": "Собственный отдел проектирования (II категория). 10 сертифицированных проектировщиков TSSR.",
    ...
    "sec-licenses-sub": "ТОО «КазЦЭП» имеет все необходимые лицензии для выполнения полного спектра инжиниринговых услуг",
    ...
    "city-shymkent": "Шымкент", "addr-shymkent": "ул. Сасбукаева, 149/1"
  },
  kk: {
    ...
    "about-title": "«КазЦЭП» ЖШС<br>— БІРГЕ дамимыз!",
    "about-desc1": "«КазЦЭП» компаниясы құрылыс нарығында 12 жылдан астам жұмыс істейді. Қазақстан Республикасының бүкіл аумағында әртүрлі жұмыстарда үлкен тәжірибе жинақталды.",
    ...
    "lic-2": "ҚМЖ лицензиясы №13016592 — II санатты СМЖ",
    "lic-3": "Экологиялық лицензия №01518Р — Қоршаған ортаны қорғау",
    "res-staff": "қызметкер<br><small>(10 TSSR жобалаушы)</small>",
    ...
    "proj-kartel-2": "«Кілт» астындағы жаңа БС монтажы — 10 сайт",
    ...
    "adv-1-title": "Жобалау тобы", "adv-1-desc": "Меншікті жобалау бөлімі (II санат). 10 TSSR сертификатталған жобалаушы.",
    ...
    "sec-licenses-sub": "«КазЦЭП» ЖШС инжиниринг қызметтерінің толық спектрін орындауға қажетті барлық лицензияларға ие",
    ...
    "city-shymkent": "Шымкент", "addr-shymkent": "Сасбукаев к., 149/1"
  },
  en: {
    ...
    "res-staff": "employees<br><small>(10 TSSR engineers)</small>",
    ...
    "proj-kartel-2": "Turnkey new BTS installation — 10 sites",
    ...
    "adv-1-title": "Design Team", "adv-1-desc": "In-house design department (Category II). 10 certified TSSR engineers.",
    ...
    "city-shymkent": "Shymkent", "addr-shymkent": "Sasbukayeva St., 149/1"
  }
};
